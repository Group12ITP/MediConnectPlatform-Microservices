...
// Use the identity connection instead of default
const identityConn = getIdentityConnection();
module.exports = identityConn.model('PatientAppointment', patientAppointmentSchema);