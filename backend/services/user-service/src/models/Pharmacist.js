...
const pharmacistSchema = new mongoose.Schema(
  {
    pharmacistId: { type: String, unique: true, index: true },
    ...
    role: { type: String, default: "pharmacist", immutable: true },
    isApproved: { type: Boolean, default: false },
    isActive: { type: Boolean, default: true },

    licenseNumber: { type: String, required: [true, "Pharmacy license number is required"], unique: true, trim: true },
